...
\subsection{A disproof of Conjecture \ref{conj:2}}
\subsection{An upper bound}
In this section we will use B-series and Theorem \ref{thm:Butcher} to calculate an upper bound for the expected order $\mathbb{E}_{\T,n}(\sigma(t)}$ of an automorphism group of a random recursive tree $t$.  
